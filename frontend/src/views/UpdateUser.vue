    ...
    >
      ...
      >
        ...
        <button
          ...
          class="text-red-500 text-xs border border-red-500 rounded-md px-2 py-1 uppercase font-medium hover:bg-red-500 hover:text-white transition-all duration-300 cursor-pointer"
        >
          Remove
        </button>
      </div>
