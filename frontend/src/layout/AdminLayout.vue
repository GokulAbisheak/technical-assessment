<template>
  <div class="min-h-screen flex flex-col bg-gray-50">
    <!-- Header -->
    <header
      class="bg-sky-600 shadow-sm sticky top-0 z-50 w-full flex justify-between items-center px-5 py-3"
    >
      <div class="text-lg font-bold text-white">Admin Panel</div>
      <nav class="flex gap-4 text-sm text-white items-center">
        <button
          @click="handleLogout"
          class="hover:bg-sky-500 cursor-pointer p-2 rounded-full transition-all duration-300"
        >
